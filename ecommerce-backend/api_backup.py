...
# from services.catalog_service import CatalogService  # Module non implémenté
# from services.cart_service import CartService  # Module non implémenté
# from services.billing_service import BillingService  # Module non implémenté
# from services.delivery_service import DeliveryService  # Module non implémenté
# from services.payment_gateway import PaymentGateway  # Module non implémenté
# from services.order_service import OrderService  # Module non implémenté
# from services.customer_service import CustomerService  # Module non implémenté
...
# Repositories seront initialisés avec la session DB dans les endpoints
# via dependency injection
sessions = SessionManager()

# Services seront initialisés avec les repositories PostgreSQL dans les endpoints
